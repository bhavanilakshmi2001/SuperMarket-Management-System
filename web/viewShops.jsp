...
<%
    ...
    try {
        ...
        ps = con.prepareStatement("SELECT * FROM shops ORDER BY shop_id DESC");
        rs = ps.executeQuery();
    } catch(Exception e) {
        e.printStackTrace();
    }
...
<head>
    ...
    <title>Manage Shops - MartSmart Admin</title>
...
<body>
    ...
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="text-white fw-bold mb-0">Partner Shops</h2>
            <span class="badge bg-white text-danger px-3 py-2 rounded-pill shadow-sm fw-bold">SHOP MANAGEMENT</span>
        </div>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="shop_images/<%= rs.getString("shop_image") %>" class="shop-img me-3" alt="Shop">
                                    <div>
                                        <div class="fw-bold text-dark"><%= rs.getString("shop_name") %></div>
                                        <div class="text-muted small">Owner: <%= rs.getString("owner_name") %></div>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                <% if ("pending".equalsIgnoreCase(status)) { %>
                                    <a href="ApproveShopServlet?id=<%= id %>" class="btn btn-success btn-action me-1">
                                        Approve
                                    </a>
                                    <a href="RejectShopServlet?id=<%= id %>" class="btn btn-outline-danger btn-action">
                                        Reject
                                    </a>
                                <% } else { %>
                        ...
                        %>
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">No shop records found.</td>
                        </tr>
                        <% } %>
                    </tbody>
                </table>
